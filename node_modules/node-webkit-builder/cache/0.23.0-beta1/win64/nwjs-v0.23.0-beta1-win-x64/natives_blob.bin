...
function ArrayCopyWithin(bf,as,at){
...
for(var x=0;x<q;x++){
var aE=p[x];
if(%_Call(bj,bk,aE,x,p)){
return aE;
}
}
return;
}
function ArrayFind(bj,bk){
...
%CreateDataProperty(av,T,br);
T++;
}
av.length=T;
return av;
}else{
var Q=(%_ToLength(bo.length));
...
%AddNamedProperty(f.prototype,n,bt,
2|1);
...
function getFunction(bv,bw,Q){
var bx=bw;
if(bu.hasOwnProperty(bv)){
bx=bu[bv];
}
if(!(Q===(void 0))){
%FunctionSetLength(bx,Q);
}
return bx;
};
var by={
...
%FunctionSetName(by.entries,"entries");
%FunctionSetName(by.keys,"keys");
%FunctionSetName(by.values,"values");
...
%InstallToContext([
"array_entries_iterator",by.entries,
"array_keys_iterator",by.keys,
"array_pop",ArrayPop,
...
"array_values_iterator",by.values,
]);
});
...
var w=b.ImportNow("to_string_tag_symbol");
var x=a.Uint8Array;
...
var D=a.Float32Array;

var E=a.Float64Array;

var F=a.Uint8ClampedArray;


var G=%object_get_prototype_of(x);
b.Import(function(H){
d=H.ArrayValues;
e=H.GetIterator;
f=H.GetMethod;
k=H.InnerArrayFind;
l=H.InnerArrayFindIndex;
m=H.InnerArrayJoin;
n=H.InnerArraySort;
o=H.InnerArrayToLocaleString;
q=H.MaxSimple;
r=H.MinSimple;
s=H.SpeciesConstructor;
t=H.ToPositiveInteger;
u=H.ToIndex;
});
function TypedArrayDefaultConstructor(I){
switch(%_ClassOf(I)){
case"Uint8Array":
return x;
...
function TypedArrayCreate(J,K,L,M){
if((L===(void 0))){
var N=new J(K);
}else{
var N=new J(K,L,M);
}
if(!(%_IsTypedArray(N)))throw %make_type_error(75);
if((typeof(K)==='number')&&%_TypedArrayGetLength(N)<K){
throw %make_type_error(258);
}
return N;
}
function TypedArraySpeciesCreate(O,K,L,M,P){
var Q=TypedArrayDefaultConstructor(O);
var J=s(O,Q,
P);
return TypedArrayCreate(J,K,L,M);
}
...
function Uint8ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*1;
%typed_array_construct_by_array_like(R,I,Z,1);
var ac=(%_ClassOf(Y)==='SharedArrayBuffer')
?h
:s(Y,h);
var ad=ac.prototype;
if((%_IsJSReceiver(ad))&&ad!==i){
%InternalSetPrototype(%TypedArrayGetBuffer(R),ad);
}
}
function Uint8ArrayConstructor(L,M,ae){
...
Uint8ArrayConstructByIterable(this,L,T);
}
}else{
...
return new x(%TypedArrayGetBuffer(this),al,ak);
}
...
function Int8ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*1;
...
function Int8ArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,1);
...
Int8ArrayConstructByIterable(this,L,T);
}
}else{
%typed_array_construct_by_length(this,L,1);
}
...
var al=
%_ArrayBufferViewGetByteOffset(this)+ah*1;
return new y(%TypedArrayGetBuffer(this),al,ak);
}
...
function Uint16ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*2;
%typed_array_construct_by_array_like(R,I,Z,2);
var ac=(%_ClassOf(Y)==='SharedArrayBuffer')
?h
:s(Y,h);
var ad=ac.prototype;
...
function Uint16ArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,2);
...
Uint16ArrayConstructByIterable(this,L,T);
}
}else{
...
return new z(%TypedArrayGetBuffer(this),al,ak);
}
...
function Int16ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*2;
...
function Int16ArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,2);
...
Int16ArrayConstructByIterable(this,L,T);
}
}else{
%typed_array_construct_by_length(this,L,2);
}
...
var al=
%_ArrayBufferViewGetByteOffset(this)+ah*2;
return new A(%TypedArrayGetBuffer(this),al,ak);
}
...
function Uint32ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*4;
%typed_array_construct_by_array_like(R,I,Z,4);
var ac=(%_ClassOf(Y)==='SharedArrayBuffer')
?h
:s(Y,h);
var ad=ac.prototype;
...
function Uint32ArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,4);
...
Uint32ArrayConstructByIterable(this,L,T);
}
}else{
...
return new B(%TypedArrayGetBuffer(this),al,ak);
}
...
function Int32ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*4;
...
function Int32ArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,4);
...
Int32ArrayConstructByIterable(this,L,T);
}
}else{
%typed_array_construct_by_length(this,L,4);
}
...
var al=
%_ArrayBufferViewGetByteOffset(this)+ah*4;
return new C(%TypedArrayGetBuffer(this),al,ak);
}
...
function Float32ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*4;
...
function Float32ArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,4);
...
Float32ArrayConstructByIterable(this,L,T);
}
}else{
%typed_array_construct_by_length(this,L,4);
}
...
var al=
%_ArrayBufferViewGetByteOffset(this)+ah*4;
return new D(%TypedArrayGetBuffer(this),al,ak);
}
...
function Float64ArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*8;
%typed_array_construct_by_array_like(R,I,Z,8);
var ac=(%_ClassOf(Y)==='SharedArrayBuffer')
?h
:s(Y,h);
var ad=ac.prototype;
...
function Float64ArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,8);
...
Float64ArrayConstructByIterable(this,L,T);
}
}else{
...
return new E(%TypedArrayGetBuffer(this),al,ak);
}
...
function Uint8ClampedArrayConstructByTypedArray(R,I){
var Y=%TypedArrayGetBuffer(I);
var Z=%_TypedArrayGetLength(I);
var aa=%_ArrayBufferViewGetByteLength(I);
var ab=Z*1;
...
function Uint8ClampedArrayConstructor(L,M,ae){
if(!(new.target===(void 0))){
if((%_ClassOf(L)==='ArrayBuffer')||(%_ClassOf(L)==='SharedArrayBuffer')){
%typed_array_construct_by_array_buffer(
this,L,M,ae,1);
...
Uint8ClampedArrayConstructByIterable(this,L,T);
}
}else{
%typed_array_construct_by_length(this,L,1);
}
...
var al=
%_ArrayBufferViewGetByteOffset(this)+ah*1;
return new F(%TypedArrayGetBuffer(this),al,ak);
}


function TypedArraySubArray(af,ag){
...
function TypedArraySet(R,ap){
var ay=(ap===(void 0))?0:(%_ToInteger(ap));
if(ay<0)throw %make_type_error(184);
if(ay>%_MaxSmi()){
...
function InnerTypedArrayEvery(aB,aC,aD,Z){
if(!(typeof(aB)==='function'))throw %make_type_error(15,aB);
for(var aq=0;aq<Z;aq++){
if(aq in aD){
var aE=aD[aq];
if(!%_Call(aB,aC,aE,aq,aD))return false;
}
}
return true;
}
function TypedArrayEvery(aB,aC){
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
return InnerTypedArrayEvery(aB,aC,this,Z);
}
%FunctionSetLength(TypedArrayEvery,1);
function InnerTypedArrayForEach(aB,aC,aD,Z){
if(!(typeof(aB)==='function'))throw %make_type_error(15,aB);
if((aC===(void 0))){
for(var aq=0;aq<Z;aq++){
if(aq in aD){
...
if(aq in aD){
var aE=aD[aq];
%_Call(aB,aC,aE,aq,aD);
}
}
}
}
function TypedArrayForEach(aB,aC){
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
InnerTypedArrayForEach(aB,aC,this,Z);
}
%FunctionSetLength(TypedArrayForEach,1);
function InnerTypedArrayFilter(aB,aC,aD,Z,aF){
var aG=0;
for(var aq=0;aq<Z;aq++){
if(aq in aD){
var aE=aD[aq];
if(%_Call(aB,aC,aE,aq,aD)){
%CreateDataProperty(aF,aG,aE);
aG++;
}
}
}
...
function TypedArrayFilter(aB,aH){
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
if(!(typeof(aB)==='function'))throw %make_type_error(15,aB);
var aF=new p();
InnerTypedArrayFilter(aB,aH,this,Z,aF);
var aI=aF.length;
...
function TypedArrayFind(aK,aH){
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
return k(aK,aH,this,Z);
}
%FunctionSetLength(TypedArrayFind,1);
function TypedArrayFindIndex(aK,aH){
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
return l(aK,aH,this,Z);
}
...
function TypedArrayMap(aB,aH){
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
var aF=TypedArraySpeciesCreate(this,Z);
if(!(typeof(aB)==='function'))throw %make_type_error(15,aB);
for(var aq=0;aq<Z;aq++){
var aE=this[aq];
aF[aq]=%_Call(aB,aH,aE,aq,this);
}
return aF;
}
%FunctionSetLength(TypedArrayMap,1);
function InnerTypedArraySome(aB,aC,aD,Z){
if(!(typeof(aB)==='function'))throw %make_type_error(15,aB);
for(var aq=0;aq<Z;aq++){
if(aq in aD){
var aE=aD[aq];
if(%_Call(aB,aC,aE,aq,aD))return true;
}
}
return false;
}
function TypedArraySome(aB,aC){
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
return InnerTypedArraySome(aB,aC,this,Z);
}
...
callback,current,aD,Z,argumentsLength){
...
if(aq in aD){
var aE=aD[aq];
current=callback(current,aE,aq,aD);
}
}
return current;
}
...
aN,aO,this,Z,arguments.length);
}
%FunctionSetLength(TypedArrayReduce,1);
function InnerArrayReduceRight(aN,aO,aD,Z,
argumentsLength){
...
if(!(%_IsTypedArray(this)))throw %make_type_error(75);
var Z=%_TypedArrayGetLength(this);
return InnerArrayReduceRight(aN,aO,this,Z,
arguments.length);
}
%FunctionSetLength(TypedArrayReduceRight,1);
function TypedArrayOf(){
var Z=arguments.length;
var aD=TypedArrayCreate(this,Z);
for(var aq=0;aq<Z;aq++){
aD[aq]=arguments[aq];
}
return aD;
...
var aD=[];
%MoveArrayContents(aQ,aD);
return aD;
}
return(%_ToObject(aP));
}
function TypedArrayFrom(an,aR,aH){
...
var aT=IterableToArrayLike(an);
var Z=(%_ToLength(aT.length));
var aU=TypedArrayCreate(this,Z);
var X,aV;
for(var aq=0;aq<Z;aq++){
X=aT[aq];
if(aS){
...
%SetCode(G,TypedArrayConstructor);
b.InstallFunctions(G,2,[
"from",TypedArrayFrom,
"of",TypedArrayOf
]);
b.InstallGetter(G.prototype,w,
...
%AddNamedProperty(G.prototype,"toString",c,
2);
%SetCode(x,Uint8ArrayConstructor);
%FunctionSetPrototype(x,new j());
%InternalSetPrototype(x,G);
%InternalSetPrototype(x.prototype,G.prototype);
...
%SetCode(y,Int8ArrayConstructor);
%FunctionSetPrototype(y,new j());
%InternalSetPrototype(y,G);
%InternalSetPrototype(y.prototype,G.prototype);
...
%SetCode(z,Uint16ArrayConstructor);
%FunctionSetPrototype(z,new j());
%InternalSetPrototype(z,G);
%InternalSetPrototype(z.prototype,G.prototype);
%AddNamedProperty(z,"BYTES_PER_ELEMENT",2,
1|2|4);
...
%SetCode(A,Int16ArrayConstructor);
%FunctionSetPrototype(A,new j());
%InternalSetPrototype(A,G);
%InternalSetPrototype(A.prototype,G.prototype);
...
%SetCode(B,Uint32ArrayConstructor);
%FunctionSetPrototype(B,new j());
%InternalSetPrototype(B,G);
%InternalSetPrototype(B.prototype,G.prototype);
%AddNamedProperty(B,"BYTES_PER_ELEMENT",4,
1|2|4);
...
%SetCode(C,Int32ArrayConstructor);
%FunctionSetPrototype(C,new j());
%InternalSetPrototype(C,G);
%InternalSetPrototype(C.prototype,G.prototype);
...
%SetCode(D,Float32ArrayConstructor);
%FunctionSetPrototype(D,new j());
%InternalSetPrototype(D,G);
%InternalSetPrototype(D.prototype,G.prototype);
...
%SetCode(E,Float64ArrayConstructor);
%FunctionSetPrototype(E,new j());
%InternalSetPrototype(E,G);
%InternalSetPrototype(E.prototype,G.prototype);
%AddNamedProperty(E,"BYTES_PER_ELEMENT",8,
1|2|4);
...
%SetCode(F,Uint8ClampedArrayConstructor);
%FunctionSetPrototype(F,new j());
%InternalSetPrototype(F,G);
%InternalSetPrototype(F.prototype,G.prototype);
...
for(let service in O){
if((getAvailableLocalesOf(service)[P]===(void 0))){
P="und";
break;
}
}
...
var ac=getAvailableLocalesOf(Z);
if(aa==='best fit'){
